...
<body>
	...
	<nav class="container-fluid bg-primary sticky-top">
		...
		<div class="row">
			<div class="col-6 display-4 text-white">Sede de la Empresa</div>
	...
	<div class="container-fluid m-4">
		<form:form action="${contextPath}/catalog/company/sede/save/"
			modelAttribute="sede" method="get">
			<div class="row">
				<div class="col-2"></div>
				<div class="col-8">
					<div class="form-row align-items-center">
						...
						<div class="col-6">
							<form:input type="hidden" path="sedeId" value="${sedeId}"></form:input>
							<label for="nombre">Nombre de Sede</label>
							<form:input type="text" class="form-control" id="nombre"
								path="nombre" value="${nombre}"
								placeholder="Nombre donde se realiza actividad laboral" autofocus="autofocus"></form:input>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<input type="hidden" id="idxSede" name="idxSede"> <input
														id="input-eliminar" type="button" class="btn btn-danger"
														value="Si, quiero eliminar"
														onclick="location.href='/catalog/company/sede/delete/'+ document.getElementById('idxSede').value;">
	...
	<script>
		$('#modal-delete').on('show.bs.modal', function(e) {
			...
			$(e.currentTarget).find('input[name="idxSede"]').val(idx);
		});
	</script>
</body>
</html>
