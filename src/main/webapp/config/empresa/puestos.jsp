...
<body>
	...
	<nav class="container-fluid bg-primary sticky-top">
		...
		<div class="row">
			<div class="col-6 display-4 text-white">Establece Puestos</div>
	...
	<div class="container-fluid m-4">
		<form:form action="${contextPath}/catalog/company/position/save/"
			modelAttribute="puesto" method="get">
			<div class="row">
				<div class="col-2"></div>
				<div class="col-8">
					<div class="form-row align-items-center">
						...
						<div class="col-6">
							<form:input type="hidden" path="puestoId" value="${puestoId}"></form:input>
							<label for="nombre">Nombre de Puesto</label>
							<form:input type="text" class="form-control" id="nombre"
								path="nombre" value="${nombre}"
								placeholder="Cargo en el cual se desempena un colaborador" autofocus="autofocus"></form:input>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<input type="hidden" id="idxPuesto" name="idxPuesto"> <input
														id="input-eliminar" type="button" class="btn btn-danger"
														value="Si, quiero eliminar"
														onclick="location.href='/catalog/company/position/delete/'+ document.getElementById('idxPuesto').value;">
	...
	<script>
		$('#modal-delete').on('show.bs.modal', function(e) {
			...
			$(e.currentTarget).find('input[name="idxPuesto"]').val(idx);
		});
	</script>
</body>
</html>
